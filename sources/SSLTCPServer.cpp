...
Susi::SSLTCPServer::SSLTCPServer(short port, std::string keyFile,
                                 std::string certFile)
...
Susi::SSLTCPServer::Session::Session(boost::asio::io_service &io_service,
                                     boost::asio::ssl::context &context,
                                     SSLTCPServer *server)
    : io_service_{io_service}, socket_{io_service, context}, server{server} {}
